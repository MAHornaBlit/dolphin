...
D3D_FEATURE_LEVEL GetFeatureLevel(IDXGIAdapter* adapter)
{
	...
	PD3D11CreateDevice(adapter, D3D_DRIVER_TYPE_UNKNOWN, NULL, /*D3D11_CREATE_DEVICE_SINGLETHREADED*/0, supported_feature_levels, NUM_SUPPORTED_FEATURE_LEVELS, D3D11_SDK_VERSION, NULL, &feat_level, NULL);
	return feat_level;
}
